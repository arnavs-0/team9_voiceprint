This folder contains the code to collect data, train, and run a model for user registration and authentication, wakeword identification, and command response. 
